...
def send_results_email():
    sender_email = "electioncommission12345@gmail.com"  # Replace with your Gmail
    sender_password = "ehateainwevfpeug"  # Use your generated App Password
    recipient_email = "rajeswaribalaganesh03@gmail.com"  # Replace with recipient's email
...
def show_results():
    ...
    root.result_window.geometry("1000x600")
    root.result_window.resizable(False, False)  # Prevent maximizing the window

    # Load background image
    bg_image_path = "C:\\Users\\sjaga\\OneDrive\\Pictures\\rbg.jpg"  # Change this to your actual image path
...
def voting_window(username):
    ...
    # Load background image
    bg_image_path = "C:\\Users\\sjaga\\OneDrive\\Pictures\\voting.jpg"  # Change this to your actual background image path
    bg_image = Image.open(bg_image_path)
    bg_image = bg_image.resize((800, 800))
    bg_photo = ImageTk.PhotoImage(bg_image)

    canvas = tk.Canvas(vote_win, width=800, height=600)
    canvas.pack(fill="both", expand=True)  # Fill the entire window
    canvas.create_image(0, 0, image=bg_photo, anchor="nw")

    parties = ["TVK", "DMK", "ADMK", "NOTA"]
    party_images = ["C:\\Users\\sjaga\\OneDrive\\Pictures\\tvk.jpg",
                    "C:\\Users\\sjaga\\OneDrive\\Pictures\\dmk.png",
                    "C:\\Users\\sjaga\\OneDrive\\Pictures\\admk.png",
                    "C:\\Users\\sjaga\\OneDrive\\Pictures\\nota.jpg"]
...
# Load background image
bg_image_path = "C:\\Users\\sjaga\\OneDrive\\Pictures\\registration.jpg"  # Change this to your actual image path
bg_image = Image.open(bg_image_path)
